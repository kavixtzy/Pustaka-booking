                            ...
                            ?>
                                <tr>
                                    ...
                                    <td nowrap>
                                        ...
                                        <a href="<?= base_url('booking/hapusbooking/' . $t['id_buku']); ?>" onclick="return confirm('Yakin Tidak Jadi Booking <?= addslashes($t['judul_buku']); ?>?');"><i class="btn btn-sm btn-outline-danger fas fw fa-trash"></i></a>
